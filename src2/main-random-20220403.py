...
class Hnefatafl:
    ...
    def choose_piece(self):
        # TODO: Need to figure out who we'll select pieces that aren't random
        if self.is_attacker_turn:
            print('Attackers turn')
            possible_pieces = self.pieces[3.0]
        else:
            print('Defenders turn')
            possible_pieces = self.pieces[2.0]
...
if __name__ == '__main__':
    ...
    for turn in range(MAX_TURNS):
        ...
        if game.is_attacker_turn:
            game_over = game.check_king_capture()
            if game_over:
                print('Congratulations! Attackers have won!')
                break
        else:
            game_over = game.check_king_win()
            if game_over:
                print('Congratulations! Defenders have won!')
                break
    ...
    ### TODO: Looks like piece #1 never moves - need to figure out if there is an issue there
    ### TODO: Need to ask Mike about some of the changes in TODOs
    ### TODO: Need to store games and features + outcomes
